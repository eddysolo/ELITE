function [GRASP_Pro_recon,kArr,idxHighResImg] = run_GRASP_Pro_seg_kArr_roi_crop_highRes(kdata,Traj,nline,K,lambHigh,numIter,flags,KM,nite,breastType,mask_tissue,recon_basis,caseInx)
% kdata: kspace-data
...
for n=1:numIter
    recon_cs = CSL1NlCgSub(recon_cs,param);
end
